...
#if !defined(__GLIBCXX__) && (!defined(_LIBCPP_ABI_MICROSOFT) || defined(_LIBCPP_NO_VCRUNTIME)) &&                \
...
void *operator new(size_t size, std::align_val_t alignment, const std::nothrow_t &) _NOEXCEPT {
    void *p = 0;
#ifndef _LIBCPP_NO_EXCEPTIONS
    try {
#endif // _LIBCPP_NO_EXCEPTIONS
...
void operator delete(void *ptr, std::align_val_t alignment, const std::nothrow_t &) _NOEXCEPT {
...
void operator delete[](void *ptr, std::align_val_t alignment) _NOEXCEPT { ::operator delete(ptr, alignment); }
...
#endif // !__GLIBCXX__ && (!_LIBCPP_ABI_MICROSOFT || _LIBCPP_NO_VCRUNTIME) &&
