...
extern uint32_t Fapi_BlockProgram(uint32_t Bank, uint32_t Flash_Start_Address, uint32_t Data_Start_Address,
                                  uint32_t Size_In_Bytes);

extern uint32_t Fapi_BlockErase(uint32_t Flash_Start_Address, uint32_t Size_In_Bytes);

extern uint32_t Fapi_UpdateStatusProgram(uint32_t Bank, uint32_t Flash_Start_Address, uint32_t Data_Start_Address,
                                         uint32_t Size_In_Bytes);

extern uint32_t Flash_Erase_Check(uint32_t Start_Address, uint32_t Bytes);

extern uint32_t Flash_Program_Check(uint32_t Program_Start_Address, uint32_t Source_Start_Address,
